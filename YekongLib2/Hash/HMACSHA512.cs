...
public class HMACSHA512 : IHashAlgorithm
{
    private System.Security.Cryptography.HMACSHA512 algorithm;

    public HMACSHA512()
    {
        algorithm = new System.Security.Cryptography.HMACSHA512();
    }

    public static string GetString(byte[] data)
    {
        var tmp = new HMACSHA512();
        tmp.Update(data);
        return tmp.GetHash();
    }
