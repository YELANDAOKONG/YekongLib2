...
public class HMACSHA256 : IHashAlgorithm
{
    private System.Security.Cryptography.HMACSHA256 algorithm;

    public HMACSHA256()
    {
        algorithm = new System.Security.Cryptography.HMACSHA256();
    }

    public static string GetString(byte[] data)
    {
        var tmp = new HMACSHA256();
        tmp.Update(data);
        return tmp.GetHash();
    }
